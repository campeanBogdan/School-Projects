...
// BOOK
    ...
    @PostMapping(value = "/view-books/search-book", params = "Search")
    public ModelAndView searchBooks(BookForm bookForm, ModelAndView mav) {
        List<BookDTO> books = bookGateway.getAllBooksLike(bookForm.getTitle());
        UserDTO userDTO = userGateway.findById(bookForm.getUserId());
        ...
        mav.addObject("books", books);
        mav.addObject("user", userDTO);
        mav.setViewName("Book/search-book");
        return mav;
    }

//    @GetMapping(value = "/view-books/search-book")
//    public ModelAndView searchBooksView(ModelAndView mav) {
//        mav.setViewName("Book/search-book");
//        return mav;
//    }
